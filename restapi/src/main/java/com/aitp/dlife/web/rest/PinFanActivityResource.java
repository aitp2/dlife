...
public class PinFanActivityResource {
	 ...
	 *
	 * @param pinFanActivityDTO
	 *            the pinFanActivityDTO to create
	 * @return the ResponseEntity with status 201 (Created) and with body the
	 *         new pinFanActivityDTO, or with status 400 (Bad Request) if the
	 *         pinFanActivity has already an ID
	 * @throws URISyntaxException
	 *             if the Location URI syntax is incorrect
	 */
	@PostMapping("/pin-fan-activities")
	@Timed
	public ResponseEntity<PinFanActivityDTO> createPinFanActivity(
			@Valid @RequestBody PinFanActivityDTO pinFanActivityDTO) throws URISyntaxException {
		log.debug("REST request to save PinFanActivity : {}", pinFanActivityDTO);
		if (pinFanActivityDTO.getId() != null) {
			throw new BadRequestAlertException("A new pinFanActivity cannot already have an ID", ENTITY_NAME,
					"idexists");
		}
		...
		log.debug("module:{},moduleEntryId:{},moduleEntryTitle:{},operator:{},operatorTime:{},nickname:{},sex:{}",
				"pinfan", "", HttpUtil.baseEncoder(pinFanActivityDTO.getActivitiyTile()), "createActivity",
	 ...
	 *
	 * @param pinFanActivityDTO
	 *            the pinFanActivityDTO to update
	 * @return the ResponseEntity with status 200 (OK) and with body the updated
	 *         pinFanActivityDTO, or with status 400 (Bad Request) if the
	 *         pinFanActivityDTO is not valid, or with status 500 (Internal
	 *         Server Error) if the pinFanActivityDTO couldn't be updated
	 * @throws URISyntaxException
	 *             if the Location URI syntax is incorrect
	 */
	@PutMapping("/pin-fan-activities")
	@Timed
	public ResponseEntity<PinFanActivityDTO> updatePinFanActivity(
			@Valid @RequestBody PinFanActivityDTO pinFanActivityDTO) throws URISyntaxException {
		...
		EventMessageDTO eventMessageDTO = eventMessageService
				.save(EventMessageBuilder.buildEventMessageDTO(result).get());
	...
	public ResponseEntity<Void> cancelPinFanActivity(@PathVariable Long id) throws URISyntaxException {
		...
		EventMessageDTO eventMessageDTO = eventMessageService
				.save(EventMessageBuilder.buildEventMessageDTO(pinFanActivityDTO).type(EventType.CANCEL).get());
		if (null != eventMessageDTO.getId()) {
			messageService.createMessageForEvent(eventMessageDTO);
		}
	...
	public ResponseEntity<List<PinFanActivityDTO>> getAllPinFanActivities(Pageable pageable,
		...
		log.debug("module:{},moduleEntryId:{},moduleEntryTitle:{},operator:{},operatorTime:{},nickname:{},sex:{}",
				"pinfan", "", "", "login", DateUtil.getYMDDateString(new Date()), wechatUserDTO.getNickName(),
				sexString);
		// log for markting end
	...
	@Timed
	public ResponseEntity<List<PinFanActivityDTO>> getAllPinFanActivitiesByUserId(Pageable pageable,
			@PathVariable String wechatUserId) {
		log.debug("REST request to get a page of PinFanActivities");
	...
	@Timed
	public ResponseEntity<List<PinFanActivityDTO>> getAllAttendedPinFanActivitiesByUserId(
			@PathVariable String wechatUserId) {
		log.debug("REST request to get a page of PinFanActivities");
	 ...
	 *
	 * @param id
	 *            the id of the pinFanActivityDTO to retrieve
	 * @return the ResponseEntity with status 200 (OK) and with body the
	 *         pinFanActivityDTO, or with status 404 (Not Found)
	 */
	...
	@Timed
	public ResponseEntity<PinFanActivityDTO> getPinFanActivityAndIsAttend(@PathVariable Long id,
			@PathVariable String wechatUserId) {
		PinFanActivityDTO pinFanActivityDTO = pinFanActivityService.findOne(id);
		...
		log.debug("module:{},moduleEntryId:{},moduleEntryTitle:{},operator:{},operatorTime:{},nickname:{},sex:{}",
				"pinfan", pinFanActivityDTO.getId(), HttpUtil.baseEncoder(pinFanActivityDTO.getActivitiyTile()), "PDP",
				DateUtil.getYMDDateString(new Date()), wechatUserDTO.getNickName(), sexString);
		// log for markting end
		return ResponseUtil.wrapOrNotFound(Optional.ofNullable(pinFanActivityDTO));
	}
	 ...
	 *
	 * @param id
	 *            the id of the pinFanActivityDTO to delete
	...
	public ResponseEntity<Void> viewCreatePinFanActivity(@PathVariable String wechatUserId) {
		...
		log.debug("module:{},moduleEntryId:{},moduleEntryTitle:{},operator:{},operatorTime:{},nickname:{},sex:{}",
				"pinfan", "", "", "createView", DateUtil.getYMDDateString(new Date()), wechatUserDTO.getNickName(),
				sexString);
		// log for markting end
