...
import { EventMessageComponent } from 'app/entities/event-message/event-message.component';
...
describe('Component Tests', () => {
    describe('EventMessage Management Component', () => {
        let comp: EventMessageComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(EventMessageComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.eventMessages[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
