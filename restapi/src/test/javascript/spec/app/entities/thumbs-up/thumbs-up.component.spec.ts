...
import { ThumbsUpComponent } from 'app/entities/thumbs-up/thumbs-up.component';
...
describe('Component Tests', () => {
    describe('ThumbsUp Management Component', () => {
        let comp: ThumbsUpComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(ThumbsUpComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.thumbsUps[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
