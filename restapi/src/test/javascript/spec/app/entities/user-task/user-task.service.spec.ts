...
describe('Service Tests', () => {
    describe('UserTask Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(UserTaskService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/user-tasks';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a UserTask', () => {
                service.create(new UserTask(null)).subscribe(received => {
            ...
            it('should update a UserTask', () => {
                service.update(new UserTask(123)).subscribe(received => {
