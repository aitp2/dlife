...
import { UserTaskComponent } from 'app/entities/user-task/user-task.component';
...
describe('Component Tests', () => {
    describe('UserTask Management Component', () => {
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.userTasks[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
