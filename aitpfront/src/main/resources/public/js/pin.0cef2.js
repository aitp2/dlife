      ...
      ? _c(
          ...
          [
            ...
            _vm._l(_vm.info.attendees, function(item) {
              return _c("div", { key: item.id, staticClass: "new-poster" }, [
                _vm._m(1, true),
                _vm._v(" "),
                _c("p", { staticClass: "poster-date" }, [
                  _vm._v("2018.4.25 2:00PM")
                ])
              ])
            }),
            _vm._v(" "),
...
var staticRenderFns = [
  function() {
    ...
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("div", { staticClass: "section attendee" }, [
      _c("p", [_c("span", { staticClass: "fs18" }), _vm._v("人已报名\n    ")]),
      _vm._v(" "),
      _c("div", [
        _c("img", {
          staticClass: "avatar",
  ...
  function() {
    ...
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("div", { staticClass: "new-poster" }, [
      _c("p", [
        _c("img", {
          staticClass: "avatar mr5",
          attrs: {
