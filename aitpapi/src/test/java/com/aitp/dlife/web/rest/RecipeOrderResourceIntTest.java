...
public class RecipeOrderResourceIntTest {
    ...
    public void setup() {
        ...
        final RecipeOrderResource recipeOrderResource = new RecipeOrderResource(recipeOrderService,recipeService,wechatUserService);
    ...
    public void updateRecipeOrder() throws Exception {
        ...
        RecipeOrder updatedRecipeOrder = recipeOrderRepository.findOne(recipeOrder.getId());
    ...
    public void updateNonExistingRecipeOrder() throws Exception {
        ...
        // Validate the RecipeOrder in the database
        List<RecipeOrder> recipeOrderList = recipeOrderRepository.findAll();
        assertThat(recipeOrderList).hasSize(databaseSizeBeforeUpdate + 1);
    }
