...
public class RecipeOrder implements Serializable {
    ...
    public Set<Evaluate> getEvaluats() {
        return evaluats;
    }

    public RecipeOrder evaluats(Set<Evaluate> evaluates) {
        this.evaluats = evaluates;
        return this;
    }

    public RecipeOrder addEvaluat(Evaluate evaluate) {
        this.evaluats.add(evaluate);
        evaluate.setRecipeOrder(this);
        return this;
    }

    public RecipeOrder removeEvaluat(Evaluate evaluate) {
        this.evaluats.remove(evaluate);
        evaluate.setRecipeOrder(null);
        return this;
    }

    public void setEvaluats(Set<Evaluate> evaluates) {
        this.evaluats = evaluates;
    }
