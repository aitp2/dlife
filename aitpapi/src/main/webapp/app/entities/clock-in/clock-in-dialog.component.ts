...
export class ClockInDialogComponent implements OnInit {
    ...
    ngOnInit() {
        ...
        this.activityParticipationService.query()
            .subscribe((res: HttpResponse<ActivityParticipation[]>) => { this.activityparticipations = res.body; }, (res: HttpErrorResponse) => this.onError(res.message));
    }
    ...
    private subscribeToSaveResponse(result: Observable<HttpResponse<ClockIn>>) {
        result.subscribe((res: HttpResponse<ClockIn>) =>
