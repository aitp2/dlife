...
export class ClockinSummaryPopupService {
    ...
    open(component: Component, id?: number | any): Promise<NgbModalRef> {
        return new Promise<NgbModalRef>((resolve, reject) => {
            ...
            if (id) {
                this.clockinSummaryService.find(id)
                    .subscribe((clockinSummaryResponse: HttpResponse<ClockinSummary>) => {
                        const clockinSummary: ClockinSummary = clockinSummaryResponse.body;
