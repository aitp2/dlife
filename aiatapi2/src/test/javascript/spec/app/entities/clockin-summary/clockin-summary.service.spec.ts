...
describe('Service Tests', () => {
    ...
    describe('ClockinSummary Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(ClockinSummaryService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/clockin-summaries';
                expect(this.lastConnection.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return ClockinSummary', () => {

                let entity: ClockinSummary;
                service.find(123).subscribe((_entity: ClockinSummary) => {
                    entity = _entity;
                });
