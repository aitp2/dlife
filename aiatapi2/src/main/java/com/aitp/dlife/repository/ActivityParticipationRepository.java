...
public interface ActivityParticipationRepository extends JpaRepository<ActivityParticipation, Long> {
    ...
    @Query(value = "select activityParticipation from ActivityParticipation activityParticipation "
            + "where activityParticipation.id in (:participationIds) and not exists(selct clockIn.activityParticipation.id from ClockIn clockIn where  activityParticipation.id = clockIn.activityParticipation.id)",nativeQuery = false)
    ...
    @Query(value = "select activityParticipation from ActivityParticipation activityParticipation "
            + "where activityParticipation.id in (:participationIds) and exists(selct clockIn.activityParticipation.id from ClockIn clockIn where  activityParticipation.id = clockIn.activityParticipation.id)",nativeQuery = false)
