package com.aitp.dlife.fitness;

import com.aitp.dlife.fitness.client.OAuth2InterceptedFeignConfiguration;
import com.aitp.dlife.fitness.config.ApplicationProperties;
import com.aitp.dlife.fitness.config.DefaultProfileUtil;
...
public class FitnessApp {
    ...
    public FitnessApp(Environment env) {
        this.env = env;
    }
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(FitnessApp.class);
